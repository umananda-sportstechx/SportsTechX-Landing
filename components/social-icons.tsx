/**
 * lucide-react v1 removed every brand glyph, so the four social marks the
 * design uses are inlined here. Single-path 24x24, `currentColor`, matching
 * lucide's sizing conventions.
 */
